    ...
    <section className="py-24 bg-black text-white overflow-hidden relative">
      ...
      >
        ...
        >
          ...
          <div className="absolute left-0 top-0 w-16 md:w-32 h-full bg-gradient-to-r from-black to-transparent pointer-events-none z-10" />
          <div className="absolute right-0 top-0 w-16 md:w-32 h-full bg-gradient-to-l from-black to-transparent pointer-events-none z-10" />
        </motion.div>
