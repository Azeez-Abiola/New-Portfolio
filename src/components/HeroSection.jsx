...
const HeroSection = () => {
  ...
  const bioText = "Proficient in Mobile and Web Development. Over the past 5 years I've helped companies, startups, founders and clients build amazing, converting, real-life products."
